...
const UUID = (process.env.UUID || "88ab2708-033b-4bb3-965f-dd0e40a9a7c8").trim();        // 替换"双引号中的UUID"
const DOMAIN = (process.env.DOMAIN || "whm.salaciousman.dpdns.org").trim();                    // 替换"双引号中的完整域名"
